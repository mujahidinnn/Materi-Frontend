    ...
    <>
      ...
      <div className="container-dashboard">
        ...
        <div className="wrap css">
          ...
          <p>
            adalah salah satu styling language (bahasa desain), bagian dari
            markup language yang dapat“mewarnai” atau mendesain suatu halaman
            website. CSS sendiri adalah singkatan dari Cascading Style Sheet.
            Markup language ini biasanya dipasangkan dengan markup language
            (bahasa marka) seperti HTML.
          </p>
        ...
        <div className="wrap javascript">
          <h2>Javascript</h2>
          <p>
            adalah suatu bahasa pemrograman tingkat tinggi dan dinamis.
        ...
        <div className="wrap reactjs">
          <h2>React JS</h2>
          <p>
            adalah libray JavaScript yang digunakan untuk membangun user
            interface yang interaktif berbasis component. React yang dibuat oleh
            Facebook dan bersifat open-source, sehingga dapat digunakan oleh
            siapa saja secara gratis. Saat ini React dikelola oleh Meta,
            komunitas, dan perusahaan individu.
          </p>

          <div className="wrap-cards">
            {DataReactjs.map((data, id) => {
              return (
                <div className="wrap-pdf" key={id}>
                  <a href={data.link} target="_blank" rel="noopener noreferrer">
                    <img src={data.pict} alt={data.name} className="img-pdf" />
      ...
      <footer>
        <p>&copy; 2023 | Pondok Programmer. Frontend Web Division</p>
      </footer>
    </>
  );
};
